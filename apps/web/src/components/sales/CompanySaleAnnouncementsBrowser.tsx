...
export function CompanySaleAnnouncementsBrowser({ companyId, onClose }: Props) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-2xl rounded-2xl border border-stone-800 bg-stone-950 my-8 max-h-[85vh] flex flex-col">
          <div className="flex items-center justify-between px-5 py-4 border-b border-stone-800 shrink-0">
            <h2 className="text-lg font-serif font-semibold text-stone-100">Sale Announcements</h2>
            <button onClick={onClose} aria-label="Close" className="p-1.5 rounded-full bg-stone-800 hover:bg-stone-700 text-stone-400 hover:text-stone-100 transition-colors">
              <X size={16} />
            </button>
          </div>

          <div className="px-5 py-3 border-b border-stone-800 flex flex-col sm:flex-row gap-3 shrink-0">
