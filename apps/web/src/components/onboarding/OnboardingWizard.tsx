...
export function OnboardingWizard() {
  ...
  // ── INPUT / LABEL classes ─────────────────────────────────────────────────
  const INPUT = 'w-full bg-stone-800 border border-stone-700 text-stone-100 rounded-lg px-3 py-2 text-sm placeholder:text-stone-500 focus:outline-none focus:border-brand-400 transition-colors'
  ...
  const steps = [
          ...
          <div className="bg-stone-800/50 border border-stone-700 rounded-xl p-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors disabled:opacity-40 ${isSubscribed ? 'bg-brand-500' : 'bg-stone-700'}`}
              >
            ...
            {pushSupported && isSubscribed && (
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <button type="button" role="switch" aria-checked={notifAppPush}
                  ...
                  className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors ${notifAppPush ? 'bg-brand-500' : 'bg-stone-700'}`}>
        ...
        <div className="bg-stone-800/50 border border-stone-700 rounded-xl p-4 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors ${notifRenewalEnabled ? 'bg-brand-500' : 'bg-stone-700'}`}
            >
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <button type="button" role="switch" aria-checked={notifRenewalInApp}
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors ${notifRenewalInApp ? 'bg-brand-500' : 'bg-stone-700'}`}>
                ...
                {pushSupported && isSubscribed && (
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <button type="button" role="switch" aria-checked={notifRenewalPush}
                      ...
                      className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors ${notifRenewalPush ? 'bg-brand-500' : 'bg-stone-700'}`}>
        ...
        <div className="bg-stone-800/50 border border-stone-700 rounded-xl p-4 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors ${notifSaleEnabled ? 'bg-brand-500' : 'bg-stone-700'}`}
            >
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <button type="button" role="switch" aria-checked={notifSaleInApp}
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors ${notifSaleInApp ? 'bg-brand-500' : 'bg-stone-700'}`}>
                ...
                {pushSupported && isSubscribed && (
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <button type="button" role="switch" aria-checked={notifSalePush}
                      ...
                      className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors ${notifSalePush ? 'bg-brand-500' : 'bg-stone-700'}`}>
    ...
    <div key="subs" className="space-y-4">
      ...
      <div className="bg-stone-800/50 border border-brand-500/20 rounded-xl p-4 space-y-3">
      ...
      <div className="w-full max-w-lg bg-stone-950 border border-stone-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center gap-1.5 px-6 py-3 shrink-0">
          {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
            <div key={i} className={`h-1 rounded-full transition-all ${i <= step ? 'bg-brand-400' : 'bg-stone-700'} ${i === step ? 'flex-[2]' : 'flex-1'}`} />
          ))}
        </div>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-stone-800 shrink-0">
          ...
          {step < TOTAL_STEPS - 1 ? (
            <button
              ...
              className="flex items-center gap-2 bg-brand-500 hover:bg-brand-400 disabled:opacity-60 text-stone-950 font-semibold text-sm px-5 py-2 rounded-xl transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-brand-500 hover:bg-brand-400 text-stone-950 font-semibold text-sm px-5 py-2 rounded-xl transition-colors"
              >
