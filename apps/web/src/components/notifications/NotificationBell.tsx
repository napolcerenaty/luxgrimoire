...
export function NotificationBell() {
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {open && (
        <div className="absolute -right-12 sm:right-0 mt-2 w-80 max-w-[calc(100vw-0.5rem)] rounded-xl border border-stone-700 bg-stone-900 shadow-2xl z-[300] overflow-hidden">
          {/* Header */}
