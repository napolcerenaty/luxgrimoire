...
export function BookCard({ book }: BookCardProps) {
  ...
  return (
    ...
    >
      <div className="aspect-[2/3] overflow-hidden rounded-lg bg-gradient-to-br from-navy-700 via-navy-800 to-navy-900 shadow-md">
        {cover ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-2 text-navy-700 px-3">
      ...
      <div>
        ...
        <h3 className="text-sm font-semibold font-serif text-navy-100 leading-snug line-clamp-2">
          {book.title}
        </h3>
