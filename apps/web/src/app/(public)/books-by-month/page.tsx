...
export default function BooksByMonthPage() {
  return (
    <div className="container mx-auto px-4 py-10 max-w-6xl">
      <h1 className="text-4xl font-serif font-bold text-stone-100 mb-1">Books by Month</h1>
      <p className="text-sm text-stone-400 mb-6">
        Every book across every book box for the selected month — see your own subscriptions highlighted, or compare across boxes.
      </p>
      <BooksByMonthClient />
    </div>
  )
