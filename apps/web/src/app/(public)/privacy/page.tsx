  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose prose-invert prose-stone max-w-none space-y-10 text-stone-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">1. Who We Are</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">2. Data We Collect</h2>
          ...
          <ul className="list-disc list-inside mt-3 space-y-1.5 text-stone-400">
            <li><strong className="text-stone-300">Account data:</strong> email address, username, password (hashed — never stored in plain text).</li>
            <li><strong className="text-stone-300">Profile data:</strong> optional display name, avatar image.</li>
            <li><strong className="text-stone-300">Collection data:</strong> editions you mark as owned, wishlisted, or pre-ordered; prices you log.</li>
            <li><strong className="text-stone-300">User-generated content:</strong> images you upload (cover photos, edition artwork).</li>
            <li><strong className="text-stone-300">Interaction data:</strong> sale announcements you submit, feature requests, bug reports, contact messages.</li>
            <li><strong className="text-stone-300">Technical data:</strong> IP address, browser type, and access logs for security and abuse prevention.</li>
          </ul>
          <p className="mt-3">We do <strong>not</strong> collect payment data — we do not process payments.</p>
        </section>

        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">3. Legal Basis for Processing (GDPR)</h2>
          <p>If you are located in the European Economic Area, our legal bases for processing your data are:</p>
          <ul className="list-disc list-inside mt-3 space-y-1.5 text-stone-400">
            <li><strong className="text-stone-300">Contract performance (Art. 6(1)(b) GDPR):</strong> to create and maintain your account and provide the core service.</li>
            <li><strong className="text-stone-300">Legitimate interests (Art. 6(1)(f) GDPR):</strong> security, fraud prevention, and improving the service.</li>
            <li><strong className="text-stone-300">Consent (Art. 6(1)(a) GDPR):</strong> for optional features such as email notifications where you explicitly opt in.</li>
            <li><strong className="text-stone-300">Legal obligation (Art. 6(1)(c) GDPR):</strong> where required by applicable law.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">4. User-Uploaded Images</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">5. How We Use Your Data</h2>
          <ul className="list-disc list-inside mt-3 space-y-1.5 text-stone-400">
        ...
        <section id="third-parties">
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">6. Third-Party Services</h2>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-3 space-y-1.5 text-stone-400">
            ...
            <li><strong className="text-stone-300">Audit logs:</strong> retained for up to 2 years for security and accountability purposes.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-3 space-y-1.5 text-stone-400">
            <li><strong className="text-stone-300">Access:</strong> request a copy of the personal data we hold about you.</li>
            <li><strong className="text-stone-300">Rectification:</strong> request correction of inaccurate data.</li>
            <li><strong className="text-stone-300">Erasure:</strong> request deletion of your data (&ldquo;right to be forgotten&rdquo;).</li>
            <li><strong className="text-stone-300">Restriction:</strong> request that we limit how we process your data.</li>
            <li><strong className="text-stone-300">Portability:</strong> request a machine-readable export of your data.</li>
            <li><strong className="text-stone-300">Objection:</strong> object to processing based on legitimate interests.</li>
            <li><strong className="text-stone-300">Withdraw consent:</strong> where processing is based on consent, withdraw it at any time.</li>
          </ul>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">10. Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-serif font-semibold text-stone-100 mb-3">11. Children</h2>
          <p>
