        ...
        include: {
          ...
          skipPolicies: {
            select: {
              ...
              maxConsecutive: true,
              windowMonths: true,
              skipDeadlineType: true,
              skipDeadlineDaysBefore: true,
              skipDeadlineDayOfMonth: true,
              notes: true,
              skipHow: true,
              allowUnskip: true,
              unskipDeadlineType: true,
              unskipDeadlineDaysBefore: true,
              unskipDeadlineDayOfMonth: true,
              unskipNotes: true,
              unskipHow: true,
            },
          },
