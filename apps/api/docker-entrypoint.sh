...
echo "▶ Relabeling subscription edition sale dates..."
node apps/api/dist/scripts/relabel-subscription-edition-sale-dates.js || echo "⚠ relabel-subscription-edition-sale-dates failed, continuing startup (idempotent — will retry on next deploy)"
