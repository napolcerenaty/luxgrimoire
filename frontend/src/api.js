...
export const API = {
  ...
  RECENT_EDITIONS:    `${API_BASE}/api/book-details/recent-editions`,
  ...
  ADMIN_IMPORT_SOURCES_ALL:                        `${API_BASE}/api/admin/import/sources`,
  ADMIN_IMPORT_SOURCES_CREATE:                     `${API_BASE}/api/admin/import/sources`,
  ADMIN_IMPORT_SOURCE_UPDATE: (id)             => `${API_BASE}/api/admin/import/sources/${id}`,
