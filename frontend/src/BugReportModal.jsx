      ...
      <div className="modal-backdrop" onClick={onClose}>
        <div className="modal-box report-modal" onClick={e => e.stopPropagation()}>
          ...
          {success ? (
            ...
            <>
              <h2 className="report-modal-title">🐛 {t("report.bugTitle")}</h2>
              ...
              <form onSubmit={handleSubmit} className="modal-form">
                <label>
                  ...
                  <input type="text" value={title} onChange={e => setTitle(e.target.value)}
                    maxLength={200} placeholder={t("report.titlePlaceholder")} autoFocus />
                </label>
                <label>
                  {t("report.descriptionLabel")}
                  <textarea value={description} onChange={e => setDescription(e.target.value)}
                    rows={4} maxLength={2000} placeholder={t("report.descriptionPlaceholder")} />
                </label>
